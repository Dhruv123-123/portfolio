...
10. Title: copy the item's "label" verbatim, only removing the word "Flight" (e.g. "BOAC Flight 781" -> "BOAC 781"; "1956 Grand Canyon mid-air collision" stays as is). Never invent a title from the operator field.
